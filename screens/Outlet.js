...
i18n.translations = {
    en: {
        welcome: 'Welcome!', outletSelected: 'Scanned into', reportIssue: 'Report\n故障报告', submitFeedback: 'Feedback\n   反馈意见', recentRptedIssue: 'Recent Reported Issue',
        reportedBy: 'Reported by', category: 'Category', dateNtime: 'Date & Time', status: 'Status', issue: 'Issue'
    },
    zh: {
        welcome: '欢迎！', outletSelected: '在商店', reportIssue: '报告问题', submitFeedback: '客户反馈', recentRptedIssue: '最近报告的问题',
